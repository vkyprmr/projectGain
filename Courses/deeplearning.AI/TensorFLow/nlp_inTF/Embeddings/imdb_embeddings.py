...
model = Sequential(
                    [
                            ...
                            Flatten(),          # Using subwords tokenizer will cause tf to crash if Flatten, so use GlobalAveragePooling1D
                            GlobalAveragePooling1D(),      # can add or remove after experiments
